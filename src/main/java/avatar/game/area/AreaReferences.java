...
public enum AreaReferences {
    ...
    GARDEN(new Area.AreaCircle(new Location(Bukkit.getWorlds().get(0), -749, 4, 329), 15, 256), "Garden", null, null),
    ...
    GLOBAL(null, "Global Wilderness", ChatChannel.GLOBAL, SPAWN, SOUTHERN_BRIDGES, GARDEN);
    //--------------------
